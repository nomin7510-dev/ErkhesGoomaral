...
<body>
  <div class="wrap">
    <header>
      <div class="logo">Goo♡</div>
      <div>
        <h1>Goomaral-д зориулсан 18 насны захиа</h1>
        <p class="lead">🎀 Энэ захиаг 18 насны төрсөн өдрөөр уншаарай</p>
      </div>
    </header>
    ...
    <div id="locked" class="locked">
      ...
      <div style="margin-top:14px">
        <div class="small">Эрхэс захиа бичсэн байгаа — хуудас нээгдсэн үед тэр мессеж автоматаар харагдана.</div>

        <div class="inputs" style="margin-top:10px">
          <div class="col">
            <label>Гоо маань Эрхэст бичих захиа (Би ч бас 2026.10.17 нд уншина)</label>
            <textarea id="guestMessage" rows="3" placeholder="Хөөрхөн Гоо маань бичээрэй..."></textarea>
          </div>

          <div style="width:220px">
            <label>Зураг оруулах (хамгийн их 5)</label>
            <input id="imageInput" type="file" accept="image/*" multiple>
            <div class="small">Upload-с зургуудаа оруулна уу. (Өөринхөө зургийг оруулаарай заа)</div>
          </div>
        </div>
